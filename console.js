			...
			for( var key in cars){
				if (cars[key].model===model_car) {
					...
					switch (param){
						...
						case 'Год': 
						var newParam=prompt("Введите новый год автомобиля");
						cars[key].year=newParam;
						break;

						case 'Модель': 
						var newParam=prompt("Введите новую модель автомобиля");
						cars[key].model=newParam;
						break;

						case 'Класс автомобиля': 
						var newParam=prompt("Введите новый класс автомобиля");
						cars[key].class_car=newParam;
						break;

						case 'Тип кузова': 
						var newParam=prompt("Введите новый тип кузова автомобиля");
